...
// ========================================
// Note: Countries are now fetched dynamically from 5SIM API
// The hardcoded COUNTRIES object has been removed
// Countries are loaded via fetchCountriesFrom5SIM() in buy-number.html
...
function displayNumbers(country, numberType, duration) {
    // Note: This function may be deprecated as countries are now fetched dynamically
    // If this function is still called, it should use the dynamically loaded countries
    // For now, we'll use a fallback approach
    const countryData = null; // Countries are now loaded dynamically from API
    const numbersGrid = document.getElementById('numbersGrid');
    const prices = {
        local: 5.99,
        tollfree: 9.99,
